...
- Crie um projeto react com create-vite: `npm init --yes vite@latest cinebattle.frontend -- --template=react-ts`.
- Criar o arquivo de projeto (`cinebattle.frontend.esproj`).
